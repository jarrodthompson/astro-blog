...
import { c as createExports } from './chunks/entrypoint_BN78bsof.mjs';
import { manifest } from './manifest_BMBSbIl5.mjs';
...
const _args = {
    "middlewareSecret": "216d4262-5680-49a6-9574-d9ace2209eca",
